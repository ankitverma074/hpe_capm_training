...
annotate service.POs with @(
    ...
    UI.HeaderInfo:{
        ...
        ImageUrl : 'https://icon2.cleanpng.com/20180807/sgk/kisspng-hewlett-packard-japan-hewlett-packard-enterprise-c-hp-recoveo-laboratoire-de-r%C3%A9cup%C3%A9ration-de-donn%C3%A9-5b6a0ce00895b6.4824491615336767680352.jpg',
    },
     UI.Identification:[
        {
            $Type : 'UI.DataField',
